...
def render_energy_table(results: list[dict], temperature_c: float = 20.0) -> None:
    ...
    with ui.element("div").classes("energy-table-wrap"):
        ...
        for col in ["vehicle", "total_kwh", "kwh_100", "soc_pct", "aero", "roll", "aux", "climb", "stop_go", "descent", "range_km"]:
            labels = {
                "vehicle": "Vehicle", "total_kwh": "Total (kWh)", "kwh_100": "kWh/100km",
                "soc_pct": "SOC %", "aero": "Aero", "roll": "Roll", "aux": "Aux",
                "climb": "Climb", "stop_go": "Stop-Go", "descent": "Descent Rec.",
                "range_km": "Range (km)",
            }
    ...
    for row in rows:
        with ui.element("div").classes("energy-card"):
            ...
            with ui.element("div").classes("energy-card-grid"):
                labels = {
                    "total_kwh": "Total (kWh)", "kwh_100": "kWh/100km",
                    "soc_pct": "SOC %", "aero": "Aero", "roll": "Roll",
                    "aux": "Aux", "climb": "Climb", "stop_go": "Stop-Go",
                    "descent": "Descent Rec.", "range_km": "Range (km)",
                }
                for col in ["total_kwh", "kwh_100", "soc_pct", "aero", "roll", "aux", "climb", "stop_go", "descent", "range_km"]:
