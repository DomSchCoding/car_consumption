...
- Implement ORS elevation or elevation enrichment, depending on available response.
...
- Optionally map-match or simply use track geometry.
- Compare recorded route vs provider route.

## Prioritized next opencode task

Implement Phase B + foundation of Phase C:
